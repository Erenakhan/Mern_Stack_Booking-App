        ...
        <form className='' onSubmit={savePlace}> 
            ...
            {photo.length > 0 && photo.map(link=>(
              <div className='relative' key={photo.id}>
                ...
                <div  className='absolute bottom-4 right-5  bg-black bg-opacity-50 rounded-xl px-4 py-2 '>
                ...
                <div  className='absolute bottom-4 left-5  bg-black bg-opacity-50 rounded-xl px-4 py-2 '>
                <button onClick={(e)=>coverPhoto(e,link)}>
                {link === photo[0] && (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="hover:text-primary text-white w-6 h-6">
            ...
            <textarea type="text" className='w-full border-2 my-1 py-2 px-3 rounded-xl'  placeholder='Kiralayacağınız yerle ile ilgili detaylı açıklama' value={desc} onChange={e=>setDesc(e.target.value)}/>
