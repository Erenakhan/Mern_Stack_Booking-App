...
export default function Account() {
  ...
  return (
    <div className='mt-4 mb-2'>
      <nav className='flex w-full justify-center gap-8 '>
        <Link
          to='/account/profile'
      ...
      {subpage === 'profile' ? (
        <div className='w-lg  mx-auto text-center mt-8'>
          ...
          <button onClick={logout}  className="w-md py-2 mt-3 bg-primary rounded-full  text-white">Çıkış Yap</button>
        </div>
      ) : (
        ''
      )}
